@extends('my_layout.appbar')
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="breadcome-heading">
                                          ...
                                          <a href="#addcomment" data-toggle="modal"  class="btn btn-flat " id="btn-primar" style=" background:black; color: #fff;"><i class="fa fa-plus"></i>&nbsp;Create Comment</a>
                                        </div>
                                    </div>
   ...
   <main role="main" class="container">
          ...
          <div class="lh-100">
            <h6 class="mb-0 text-white lh-100">Comments Listinings</h6>
            ...
            <div class="my-3 p-3 bg-white rounded box-shadow">
              ...
              <div class="media text-muted pt-3">
                ...
                <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                   {{ $comment->body }} <strong class="d-block text-gray-dark"><a href="{{$comment->url}}" target="_"> {{$comment->url}}</a></strong>
                    
                </p>
                <br><br>  
                 {!! Form::open(['method' => 'DELETE', 'route' => ['comments.destroy',$comment->id ],'onsubmit' => 'return confirm("Are you sure you want to delete?")']) !!}
